...
import RickOwensImg from '../assets/img/rickowens.png';
const Card = () => {
  return (
    <StyledWrapper>
      <div id='cards' className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 px-4'>
 
			<div className="card">
				<div className="card-img"><img src={RickOwensImg} alt='Rick Owens'/></div> 
